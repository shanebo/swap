...
import { addContinueDirective, addRepeatDirective, continueForm, repeatForm, submitExternalForm } from './form.js';
...
swap.to = (html, selectors, inline, callback) => {
  // if (!inline) {
    // a captureState here could save latest html state on history.state
  // }
  fireElements('off');
