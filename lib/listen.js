...
export default function() {
  ...
  swap.event('click', swap.opts.confirmCancelTrigger, (e) => {
    removeConfirm();
    delete swap.confirmEvent;
  });


  swap.event('click', swap.opts.confirmOkTrigger, () => {
  ...
  swap.event('click', swap.opts.continueTrigger, (e) => {
  ...
  swap.event('click', swap.opts.repeatTrigger, (e) => {
    const form = e.target.closest('form');
    if (form) {
