...
const defaults = ({ paneClass }) => ({
  ...
  confirmTemplate: `
    <div class="Confirm">
      <h2 class="Confirm-title" data-swap-model-confirm-title></h2>
      <div class="Confirm-actions">
        <button class="Confirm-cancelBtn" data-swap-model-confirm-cancel></button>
        <button class="Confirm-okBtn" data-swap-model-confirm-ok></button>
      </div>
    </div>
  `,
