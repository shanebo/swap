...
module.exports = function(options = {}) {
  ...
  const dependentDefaults = {
    paneForms: `${opts.paneActive} ${opts.form}`,
    paneContent: `${opts.paneActive} .Pane-content`,
    paneTemplate: `
    ...
    `,
    paneSelectors: [`${opts.paneDefaultEl} ${opts.paneDefaultRenderType} ${opts.paneActive} .Pane-content`],
    // paneSelectors: [`${opts.paneDefaultEl} ${opts.paneDefaultRenderType} ${dependentDefaults.paneContent}`],
    css: `
  ...
  swap.opts = { ...dependentDefaults, ...opts };
}
