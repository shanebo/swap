...
const paneTemplate = `
    <div class="Pane light-mode">
      <button class="PaneCloseBtn Button Button--default Button--circle Button--icon icon-x Button--medium"></button>
      <button class="PaneExpandBtn Button Button--default Button--circle Button--icon icon-maximize-2 Button--medium"></button>
