...
import { $html, htmlToElement, getPreviousSibling, qs, parseQuery } from './utils.js';
...
const addPane = ({ html, finalUrl, selectors }, bypass = false) => {
  ...
  $html.classList.add(swap.opts.paneIsOpen);
...
const closePanes = () => {
  $html.classList.remove(swap.opts.paneIsOpen);
